...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate deposit amount is a number and less than or equal to 100000
    if ($amount > 0 && $amount <= 100000) {
        ...
        $transaction_sql = "INSERT INTO transactions (user_id, type, amount) VALUES ($user_id, 'deposit', $amount)";
        $conn->query($transaction_sql);

        header("Location: dashboard.php");  // Redirect back to dashboard after deposit
        exit;
    } else {
...
<body>
    ...
    <div class="username">Name:  <?php echo htmlspecialchars($username); ?></div>
        ...
        <form method="post" action="" onsubmit="return validateForm()">
            <input type="number" step="0.01" name="amount" id="amount" placeholder="Enter amount to deposit" min="0" max="100000" required>
